...
public String produceValue(Annotation np1, Annotation np2, Document doc, Map<Feature, String> featMap)
{
  ...
  if (type1 != null && type2 != null && type1.equals(NPSemTypeEnum.LOCATION)
      && type2.equals(NPSemTypeEnum.LOCATION)) return INCOMPATIBLE;
  NPSemTypeEnum nptype1 = NPSemanticType.getValue(np1, doc);
  NPSemTypeEnum nptype2 = NPSemanticType.getValue(np2, doc);

  if ((NPSemTypeEnum.DATE.equals(nptype1) && !NPSemTypeEnum.DATE.equals(nptype2))
      || (!NPSemTypeEnum.DATE.equals(nptype1) && NPSemTypeEnum.DATE.equals(nptype2)))
    return INCOMPATIBLE;
