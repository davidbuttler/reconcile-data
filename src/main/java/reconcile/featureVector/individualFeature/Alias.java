...
public String produceValue(Annotation np1, Annotation np2, Document doc, Map<Feature, String> featVector)
{
  ...
  if (NPSemTypeEnum.PERSON.equals(type1) || NPSemTypeEnum.PERSON.equals(type2)) {
    if (!FeatureUtils.memberArray("and", words1) && !FeatureUtils.memberArray("and", words2)
        ...
        && !DataConstructor.createFeature("Gender").getValue(np1, np2, doc, featVector).equals(NominalFeature.INCOMPATIBLE)) {
  ...
  if (NPSemTypeEnum.ORGANIZATION.equals(type1) && type1.equals(type2)) {
