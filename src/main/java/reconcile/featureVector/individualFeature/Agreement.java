...
{
  String gender = DataConstructor.createFeature("Gender").getValue(np1, np2, doc, featVector);
  String number = DataConstructor.createFeature("Number").getValue(np1, np2, doc, featVector);
  String animacy = DataConstructor.createFeature("Animacy").getValue(np1, np2, doc, featVector);
